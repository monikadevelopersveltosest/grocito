      ...
      <div class="col-xs-12">
        <div class="box">
          <div class="box-header col-md-6" style="float: left;">
            <h3 class="box-title">
                <a href="<?php echo base_url();?>adminnew/add_brand_logo" class="btn btn-primary pull-right">Add New </a>
            </h3>
          </div>
                ...
                <?php $count = 1; 
                  ...
                  ?>
                    <tr>
                      ...
                      <td>
                        &nbsp;
                        <a href="<?php echo base_url() ?>adminnew/add_brand_logo/<?php echo $getdata['id']; ?>" title="Edit"><i class="fa   fa-pencil-square-o" aria-hidden="true"></i></a> 
                        &nbsp;
                       <!--  &nbsp;
                        <a href="<?php echo base_url() ?>adminnew/add_brand_logo/<?php echo $getdata['id']; ?>" title="Edit Brand"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a> 
                        &nbsp; -->
                        <!-- <?php if($ul['status'] == 1){ ?>
...
<!-- <script type="text/javascript">
    ...
    $('.btn_delete').click(function(){
        ...
        $.ajax({
            type: 'POST',
            url:"<?php echo base_url()?>adminnew/brand_logo",
            data:{id:id,table:'brand_logo',colwhr:'id'},
            dataType: 'json',
            success : function(data){
                if (data.status == 1){
