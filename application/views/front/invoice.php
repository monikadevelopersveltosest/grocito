  ...
  <div class="content-wrapper">
      ...
      <section class="invoice">
              ...
              ?>
                ...
                ?>
                    <tr class="cart-item">
                        ...
                        <td class="product-price d-lg-table-cell">
                          <span class="pr-3 d-block price"><span id="price"><?php echo $spdataarray['price']; ?></span></span>
                        </td>
                        <td  class="product-price d-lg-table-cell">
          ...
          <div class="col-xs-6">
            ...
            <div class="table-responsive">
              <table class="table">
                ...
                <!--  <td>RS <?php echo $product['gst_amount']; ?></td>-->
                <!--</tr>-->
                <tr>
                    <th style="width:50%">GST (Included in price):</th>
                    <td>RS <span id="gst_amount"></span></td>
                </tr>
        ...
        <div class="row no-print">
          <div class="col-xs-12">
            <a href="javascript:void(0)" target="_blank" class="btn btn-default print_invoice"><i class="fa fa-print"></i> Print</a>
          </div>
        </div>
      </section>
      <!-- /.content -->
