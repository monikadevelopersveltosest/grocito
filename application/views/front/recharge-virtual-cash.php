            ...
            <div class="account-wrapper mt--100 mt-lg--440">
                <div class="left-side">
                    <div class="section-header">
                        <h2 class="title">Seller's Virtual Cash </h2>
                   ...
                   <!--  <div class="or">
                    ...
                    <form class="login-form">
                        <div class="form-group mb-30">
                            <label for="amount"><i class="fa fa-id-badge" aria-hidden="true"></i></label>
                            <input type="text" id="" placeholder="Amount">
                        </div>
                        <div class="form-group">
                            <label for="upi-id"><i class="fa fa-id-badge" aria-hidden="true"></i></label>
                            <input type="text" id="login-pass" placeholder="UPI-ID">
                        </div>
                       <!--  <div class="form-group">
