                   ...
                   <?php } ?>
                    ...
                    <form  id="loginform" method="post" style="padding: 15px;">
                      <div class="form-group has-feedback">
                       ...
                       <!--  <input type="tel" class="form-control" id="mobile_no" name="mobile_no" placeholder="Mobile No." pattern="[0-9]{3}[0-9]{3}[0-9]{4}" required> -->
                       <br>
                       <select name="country_code" class="" style="width:53px; height: 34px;display: initial;">
                        <option>+1</option>
                        <option>+91</option>
                      </select>
                      <input type="tel" class="form-control" style="width:84%; height: 34px; display: inline-block;" pattern="[0-9]{3}[0-9]{3}[0-9]{4}" class="form-control" name="mobile_no" size="10" required placeholder="Mobile No." />
                    ...
                    <a href="<?php echo base_url()?>home/forget_password" class="col-xs-4"><button class="btn btn-block btn-flat">Forget Password</button></a>
                </div>
            </div>
        </div>
    </div>
